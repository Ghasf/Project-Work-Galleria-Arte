...
--
-- Host: 127.0.0.1
-- Creato il: Ott 07, 2021 alle 20:08
...
(6, '', '2021-12-06', '2021-12-12', NULL, NULL),
(7, '', '2021-10-25', '2021-10-27', NULL, NULL);
...
--
ALTER TABLE `prenotazioni`
  MODIFY `id_prenotazione` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
